...
INSERT INTO user_profiles (email, name, role, department, active) VALUES
  ('sustainability@BitCapro.com', 'Green Smith', 'Sustainability_Officer', 'ESG', true),
  ('legal@BitCapro.com', 'Legal Eagle', 'Legal_Officer', 'Legal', true),
  ('compliance@BitCapro.com', 'Compliance Jones', 'Compliance_Officer', 'Compliance', true),
  ('bizdev@BitCapro.com', 'Business Developer', 'Business_Development', 'Strategy', true),
  ('assets@BitCapro.com', 'Asset Manager', 'Asset_Manager', 'Operations', true)
